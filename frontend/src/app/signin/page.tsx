        ...
        <div>
          ...
          <ul className="space-y-4">
            {[
              ...
              { icon: '💰', text: 'Transparent per-token pricing, no surprises' },
            ].map((item) => (
...
function SignInForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      <div>
        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text)' }} htmlFor="signin-email">
          Email address
        </label>
        <input
          id="signin-email"
      ...
      <div>
        <div className="flex items-center justify-between mb-1.5">
          <label className="text-sm font-medium" style={{ color: 'var(--text)' }} htmlFor="signin-password">
            Password
          </label>
          <a href="#" className="text-xs hover:underline" style={{ color: 'var(--accent)' }}>
            Forgot password?
          </a>
        </div>
        <input
...
function SignUpForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      <div>
        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text)' }} htmlFor="signup-name">
          Full name
        </label>
        <input
          id="signup-name"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text)' }} htmlFor="signup-email">
          Email address
        </label>
        <input
          id="signup-email"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text)' }} htmlFor="signup-password">
          Password
        </label>
        <input
          id="signup-password"
      ...
      <div>
        <label className="block text-sm font-medium mb-1.5" style={{ color: 'var(--text)' }} htmlFor="signup-confirm">
          Confirm password
        </label>
        <input
          id="signup-confirm"
...
function OAuthButtons() {
  ...
  const handleOAuth = (provider: string) => {
    addToast(`${provider} OAuth — coming soon!`, 'info');
  };
